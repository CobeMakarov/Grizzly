package net.cobem.grizzly.events.composers;
...
{	
    ...
    public static short MyData = 962; //NEW 1663
    ...
    public static short Sign = 2458;
    public static short ChangeLooks = 1216;
    public static short RequestWave = 3593;
	 ...
	 * Outgoing
	 */
    public static int Login = 3984; //OLD 3984 NEW 1552
    public static int LoadProfile = 1295; //OLD 1295 NEW 525
    public static int UserInfo = 3538; //OLD 3538 NEW 3207
	...
	public static int LoadFriends = 1386; //OLD 1386 NEW 63
